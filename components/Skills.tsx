...
export default function Skills() {
  return (
    <section id="skills" className="py-20 border-t border-gray-800 bg-[#0d1117]">
      <div className="max-w-5xl mx-auto px-6">
        <div className="mb-10">
          <h2 className="text-2xl font-bold tracking-tight text-gray-100 mb-1">Skills</h2>
          <p className="text-sm text-gray-500">Tools and methods I work with.</p>
        </div>
